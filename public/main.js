...
document.getElementById('rec').onclick=recommendations;

function recommendations(){
  document.getElementById('list').innerHTML="1.Dragonball 2.Naruto Shippuden 3.Hunter X Hunter 4.Yu Yu Hakusho 5.Bleach"
